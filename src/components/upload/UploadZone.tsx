...
export default function UploadZone() {
  ...
  return (
    <div className="max-w-2xl animate-fade-in">
      ...
      {/* How it works */}
      <div className="mt-6 p-5 rounded-xl" style={{ background: "var(--glass)", border: "1px solid var(--border)" }}>
        <div className="text-sm font-semibold mb-3">How parsing works</div>
        <div className="grid grid-cols-2 gap-3">
          {[
            ["⚡", "Instant", "All PDFs processed in parallel — no waiting"],
            ["🔍", "Smart Extract", "Name, email, phone, city, education auto-detected"],
            ["🎯", "Role Match", "Keywords matched to find the best-fit role"],
            ["📊", "Auto Score", "Skills (40%) + Exp (25%) + Edu (20%) + Completeness (15%)"],
          ].map(([icon, title, desc]) => (
